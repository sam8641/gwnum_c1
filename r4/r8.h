...
#define r8_x8c_simple_fft_part2(src,dstreg,d1,d2) { \
	vec2f64 *dd0 = (vec2f64*)(dstreg); \
	vec2f64 *dd1 = (vec2f64*)(dstreg+d1); \
	vec2f64 *dd2 = (vec2f64*)(dstreg+d2); \
	vec2f64 *dd3 = (vec2f64*)(dstreg+d2+d1); \
	xmm2 = src[8];			/* R5 */ \
	xmm0 = src[9]; 		/* R6 */ \
	xmm7 = xmm2;			/* Copy R5 */ \
...
#define r8_x8cl_eight_complex_with_mult(srcreg,srcinc,d1,d2,d4) { \
	...
	r8_x8c_simple_fft_part1(srcreg+32,d1,d2,d4,XMM_COL_MULTS_2); \
	r8_x8c_simple_fft_part1(srcreg+0,d1,d2,d4,XMM_COL_MULTS_1); \
	r8_x8c_simple_fft_with_mult(XMM_COL_MULTS_1,src_rbp,d1,d2); \
	r8_x8c_simple_unfft(XMM_COL_MULTS_1,srcreg+0,d1,d2); \
...
\
	xmm0 = xptr2(src,d2);			/* R5 */ \
	xmm1 = xptr2(src,d2+16); 		/* R6 */ \
	xmm7 = xmm0;			/* Copy R5 */ \
	xmm0 -= xmm1;			/* R5 = R5 - R6 (new R6) */ \
	xmm1 += xmm7;			/* R6 = R5 + R6 (new R5) */ \
\
	xmm2 = xptr2(src,d2+32);		/* I5 */ \
	xmm3 = xptr2(src,d2+48); 		/* I6 */ \
	xmm7 = xmm2;			/* Copy I5 */ \
	xmm2 -= xmm3;			/* I5 = I5 - I6 (new I6) */ \
	xmm3 += xmm7;			/* I6 = I5 + I6 (new I5) */ \
\
	xp_complex_mult(xmm0, xmm2, xptr(altsrc+d2+16), xptr(altsrc+d2+48), xmm6, xmm7); /* Mult R6/I6 */ \
	xp_complex_mult(xmm1, xmm3, xptr(altsrc+d2), xptr(altsrc+d2+32), xmm6, xmm7); /* Mult R5/I5 */ \
\
	xmm7 = xmm1;			/* Copy R5 */ \
	xmm1 -= xmm0;			/* R5 = R5 - R6 (new R6) */ \
	xmm0 += xmm7;			/* R6 = R5 + R6 (new R5) */ \
\
	xmm7 = xmm3;			/* Copy I5 */ \
	xmm3 -= xmm2;			/* I5 = I5 - I6 (new I6) */ \
	xmm2 += xmm7;			/* I6 = I5 + I6 (new I5) */ \
\
	xptr2(src,d2+16) = xmm1;		/* Save R6 */ \
	xptr2(src,d2) = xmm0;			/* Save R5 */ \
	xptr2(src,d2+48) = xmm3;		/* Save I6 */ \
	xptr2(src,d2+32) = xmm2;		/* Save I5 */ \
\
	xmm0 = xptr2(src,d2+d1);		/* R7 */ \
	xmm1 = xptr2(src,d2+d1+48);		/* I8 */ \
	xmm7 = xmm0;			/* Copy R7 */ \
	xmm0 -= xmm1;			/* R7 = R7 - I8 (new R7) */ \
	xmm1 += xmm7;			/* I8 = R7 + I8 (new R8) */ \
\
	xmm2 = xptr2(src,d2+d1+32);		/* I7 */ \
	xmm3 = xptr2(src,d2+d1+16);		/* R8 */ \
	xmm7 = xmm2;			/* Copy I7 */ \
	xmm2 -= xmm3;			/* I7 = I7 - R8 (new I8) */ \
	xmm3 += xmm7;			/* R8 = I7 + R8 (new I7) */ \
\
	xp_complex_mult(xmm1, xmm2, xptr(altsrc+d2+d1+16), xptr(altsrc+d2+d1+48), xmm6, xmm7); /* Mult R8/I8 */ \
	xp_complex_mult(xmm0, xmm3, xptr(altsrc+d2+d1), xptr(altsrc+d2+d1+32), xmm6, xmm7); /* Mult R7/I7 */ \
\
	xmm7 = xmm1;			/* Copy R8 */ \
...
\
	xmm7 = xmm3;			/* Copy I7 */ \
	xmm3 -= xmm2;			/* I7 = I7 - I8 (new R8) */ \
	xmm2 += xmm7;			/* I8 = I7 + I8 (new I7) */ \
\
	xptr2(src,d2+d1+48) = xmm1;		/* Save I8 */ \
	xptr2(src,d2+d1) = xmm0;		/* Save R7 */ \
	xptr2(src,d2+d1+16) = xmm3;		/* Save R8 */ \
	xptr2(src,d2+d1+32) = xmm2;		/* Save I7 */ \
\
	xmm0 = xptr2(src,0);			/* R1 */ \
	xmm1 = xptr2(src,16);			/* R2 */ \
	xmm7 = xmm0;			/* Copy R1 */ \
	xmm0 -= xmm1;			/* R1 = R1 - R2 (new R2) */ \
	xmm1 += xmm7;			/* R2 = R1 + R2 (new R1) */ \
\
	xmm2 = xptr2(src,32);			/* I1 */ \
	xmm3 = xptr2(src,48);			/* I2 */ \
	xmm7 = xmm2;			/* Copy I1 */ \
	xmm2 -= xmm3;			/* I1 = I1 - I2 (new I2) */ \
	xmm3 += xmm7;			/* I2 = I1 + I2 (new I1) */ \
\
	xp_complex_mult(xmm0, xmm2, xptr(altsrc+16), xptr(altsrc+48), xmm6, xmm7); /* Mult R2/I2 */ \
	xp_complex_mult(xmm1, xmm3, xptr(altsrc), xptr(altsrc+32), xmm6, xmm7); /* Mult R1/I1 */ \
\
	xmm7 = xmm1;			/* Copy R1 */ \
...
\
	xmm7 = xmm3;			/* Copy I1 */ \
	xmm3 -= xmm2;			/* I1 = I1 - I2 (new I2) */ \
	xmm2 += xmm7;			/* I2 = I1 + I2 (new I1) */ \
\
	xptr2(src,16) = xmm1;			/* Save R2 */ \
	xptr2(src,0) = xmm0;			/* Save R1 */ \
	xptr2(src,48) = xmm3;			/* Save I2 */ \
	xptr2(src,32) = xmm2;			/* Save I1 */ \
\
	xmm0 = xptr2(src,d1);			/* R3 */ \
	xmm1 = xptr2(src,d1+48);		/* I4 */ \
	xmm7 = xmm0;			/* Copy R3 */ \
	xmm0 -= xmm1;			/* R3 = R3 - I4 (new R3) */ \
	xmm1 += xmm7;			/* I4 = R3 + I4 (new R4) */ \
\
	xmm2 = xptr2(src,d1+32);		/* I3 */ \
	xmm3 = xptr2(src,d1+16);		/* R4 */ \
	xmm7 = xmm2;			/* Copy I3 */ \
	xmm2 -= xmm3;			/* I3 = I3 - R4 (final I4) */ \
	xmm3 += xmm7;			/* R4 = I3 + R4 (final I3) */ \
\
	xp_complex_mult(xmm1, xmm2, xptr(altsrc+d1+16), xptr(altsrc+d1+48), xmm6, xmm7); /* Mult R4/I4 */ \
	xp_complex_mult(xmm0, xmm3, xptr(altsrc+d1), xptr(altsrc+d1+32), xmm6, xmm7); /* Mult R3/I3 */ \
\
	xmm7 = xmm1;			/* Copy R4 */ \
...
\
	xmm7 = xmm3;			/* Copy I3 */ \
	xmm3 -= xmm2;			/* I3 = I3 - I4 (new R4) */ \
	xmm2 += xmm7;			/* I4 = I3 + I4 (new I3) */ \
\
	xptr2(src,d1+48) = xmm1;		/* Save I4 */ \
	xptr2(src,d1) = xmm0;			/* Save R3 */ \
	xptr2(src,d1+16) = xmm3;		/* Save R4 */ \
	xptr2(src,d1+32) = xmm2;		/* Save I3 */ \
\
/* */ \
...
#define r8_x8c_simple_fft_with_mulf(srcreg,d1,d2,dst) { \
	...
	uintptr_t src_rbp = srcreg+rbp; \
	xmm0 = xptr(src_rbx+d2+16);	/* R6 */ \
	xmm2 = xptr(src_rbx+d2+48);	/* I6 */ \
	xmm1 = xptr(src_rbx+d2);		/* R5 */ \
	xmm3 = xptr(src_rbx+d2+32);	/* I5 */ \
\
	xp_complex_mult(xmm0, xmm2, xptr(src_rbp+d2+16), xptr(src_rbp+d2+48), xmm6, xmm7); /* Mult R6/I6 */ \
	xp_complex_mult(xmm1, xmm3, xptr(src_rbp+d2), xptr(src_rbp+d2+32), xmm6, xmm7); /* Mult R5/I5 */ \
\
	xmm7 = xmm1;			/* Copy R5 */ \
	xmm1 -= xmm0;			/* R5 = R5 - R6 (new R6) */ \
	xmm0 += xmm7;			/* R6 = R5 + R6 (new R5) */ \
\
	...
	xmm2 += xmm7;			/* I6 = I5 + I6 (new I5) */ \
\
	xptr2(dst,d2+16) = xmm1;		/* Save R6 */ \
	xptr2(dst,d2) = xmm0;			/* Save R5 */ \
	xptr2(dst,d2+48) = xmm3;		/* Save I6 */ \
	xptr2(dst,d2+32) = xmm2;		/* Save I5 */ \
\
	xmm1 = xptr(src_rbx+d2+d1+16);	/* R8 */ \
	xmm2 = xptr(src_rbx+d2+d1+48);	/* I8 */ \
	xmm0 = xptr(src_rbx+d2+d1);	/* R7 */ \
	xmm3 = xptr(src_rbx+d2+d1+32);	/* I7 */ \
\
	xp_complex_mult(xmm1, xmm2, xptr(src_rbp+d2+d1+16), xptr(src_rbp+d2+d1+48), xmm6, xmm7); /* Mult R8/I8 */ \
	xp_complex_mult(xmm0, xmm3, xptr(src_rbp+d2+d1), xptr(src_rbp+d2+d1+32), xmm6, xmm7); /* Mult R7/I7 */ \
\
	xmm7 = xmm1;			/* Copy R8 */ \
	xmm1 -= xmm0;			/* R8 = R8 - R7 (new I8) */ \
	xmm0 += xmm7;			/* R7 = R8 + R7 (new R7) */ \
\
	...
	xmm2 += xmm7;			/* I8 = I7 + I8 (new I7) */ \
\
	xptr2(dst,d2+d1+48) = xmm1;		/* Save I8 */ \
	xptr2(dst,d2+d1) = xmm0;		/* Save R7 */ \
	xptr2(dst,d2+d1+16) = xmm3;		/* Save R8 */ \
	xptr2(dst,d2+d1+32) = xmm2;		/* Save I7 */ \
\
	xmm0 = xptr(src_rbx+16);		/* R2 */ \
	xmm2 = xptr(src_rbx+48);		/* I2 */ \
	xmm1 = xptr(src_rbx);		/* R1 */ \
	xmm3 = xptr(src_rbx+32);		/* I1 */ \
\
	xp_complex_mult(xmm0, xmm2, xptr(src_rbp+16), xptr(src_rbp+48), xmm6, xmm7); /* Mult R2/I2 */ \
	xp_complex_mult(xmm1, xmm3, xptr(src_rbp), xptr(src_rbp+32), xmm6, xmm7); /* Mult R1/I1 */ \
\
	xmm7 = xmm1;			/* Copy R1 */ \
	xmm1 -= xmm0;			/* R1 = R1 - R2 (new R2) */ \
	xmm0 += xmm7;			/* R2 = R1 + R2 (new R1) */ \
\
	...
	xmm2 += xmm7;			/* I2 = I1 + I2 (new I1) */ \
\
	xptr2(dst,16) = xmm1;			/* Save R2 */ \
	xptr2(dst,0) = xmm0;			/* Save R1 */ \
	xptr2(dst,48) = xmm3;			/* Save I2 */ \
	xptr2(dst,32) = xmm2;			/* Save I1 */ \
\
	xmm1 = xptr(src_rbx+d1+16);	/* R4 */ \
	xmm2 = xptr(src_rbx+d1+48);	/* I4 */ \
	xmm0 = xptr(src_rbx+d1);		/* R3 */ \
	xmm3 = xptr(src_rbx+d1+32);	/* I3 */ \
\
	xp_complex_mult(xmm1, xmm2, xptr(src_rbp+d1+16), xptr(src_rbp+d1+48), xmm6, xmm7); /* Mult R4/I4 */ \
	xp_complex_mult(xmm0, xmm3, xptr(src_rbp+d1), xptr(src_rbp+d1+32), xmm6, xmm7); /* Mult R3/I3 */ \
\
	xmm7 = xmm1;			/* Copy R4 */ \
	xmm1 -= xmm0;			/* R4 = R4 - R3 (new I4) */ \
	xmm0 += xmm7;			/* R3 = R4 + R3 (new R3) */ \
\
	...
	xmm2 += xmm7;			/* I4 = I3 + I4 (new I3) */ \
\
	xptr2(dst,d1+48) = xmm1;		/* Save I4 */ \
	xptr2(dst,d1) = xmm0;			/* Save R3 */ \
	xptr2(dst,d1+16) = xmm3;		/* Save R4 */ \
	xptr2(dst,d1+32) = xmm2;		/* Save I3 */ \
}
...
#define r8_sg8cl_eight_complex_fft8(srcreg,srcinc,d1,d2,d4,dstreg,dstinc,e1,e2,e4,screg) { \
	...
	vec2f64 *sd4 = (vec2f64*)(srcreg+d4); \
	vec2f64 *sd5 = (vec2f64*)(srcreg+d4+d1); \
	vec2f64 *sd6 = (vec2f64*)(srcreg+d4+d2); \
	vec2f64 *sd7 = (vec2f64*)(srcreg+d4+d2+d1); \
	r8_s8c_fft8_srcreg(0,1,dstreg+0,e1,e2,screg,0); \
	r8_s8c_fft8_srcreg(2,3,dstreg+e4,e1,e2,screg,0); \
	srcreg += srcinc; \
	dstreg += dstinc; \
}
#if 1  // x86
#define r8_s8c_fft8_srcreg(S0,S1,dstreg,e1,e2,screg,scoff) { \
	vec2f64 *de0 = (vec2f64*)(dstreg); \
	vec2f64 *de1 = (vec2f64*)(dstreg+e1); \
	vec2f64 *de2 = (vec2f64*)(dstreg+e2); \
	vec2f64 *de3 = (vec2f64*)(dstreg+e2+e1); \
	xmm0 = sd0[S0];			/* R1 */ \
	xmm2 = sd4[S0];			/* R5 */ \
	xmm5 = xmm2;			/* Copy R5 */ \
	xmm2 += xmm0;			/* R5 = R1 + R5 (new R1) */ \
...
\
	...
	xmm7 += xmm5;			/* I7 = I3 + I7 (new I3) */ \
\
	xmm4 -= sd4[S1];		/* I1 = I1 - I5 (new I5) */ \
	xmm5 -= sd6[S1];		/* I3 = I3 - I7 (new I7) */ \
\
...
\
	...
	xmm6 += xmm4;			/* I6 = I2 + I6 (new I2) */ \
\
	xmm0 -= sd5[S0];		/* R2 = R2 - R6 (new R6) */ \
	xmm1 -= sd7[S0];		/* R4 = R4 - R8 (new R8) */ \
\
	xmm5 = xmm3;			/* Copy R4 */ \
	xmm3 += xmm2;			/* R4 = R2 + R4 (final R2) */ \
	xmm2 -= xmm5;			/* R2 = R2 - R4 (final R4) */ \
\
	...
	xmm7 += xmm5;			/* I8 = I4 + I8 (new I4) */ \
\
	xmm4 -= sd5[S1];		/* I2 = I2 - I6 (new I6) */ \
	xmm5 -= sd7[S1];		/* I4 = I4 - I8 (new I8) */ \
\
...
\
	xmm6 *= xptr(screg+scoff+160);		/* A6 = A6 * sine (final R6) */ \
	xmm7 *= xptr(screg+scoff+32);		/* A5 = A5 * sine (final R5) */ \
	shuffle_store(de2[0], de2[1], xmm7, xmm6);	/* Save R5,R6 */ \
\
	xmm6 = xptr(screg+scoff+96+16);	/* cosine/sine */ \
	xmm6 *= xmm2;			/* A7 = R7 * cosine/sine */ \
	xmm6 -= xmm5;			/* A7 = A7 - I7 */ \
...
\
	...
	xmm1 *= xptr(screg+scoff+32);		/* B5 = B5 * sine (final I5) */ \
\
	shuffle_store_with_temp(de2[2], de2[3], xmm1, xmm3, xmm7); /* Save I5,I6 */ \
\
	xmm3 = xptr(screg+scoff+224+16);	/* cosine/sine */ \
	xmm3 *= xmm4;			/* A8 = R8 * cosine/sine */ \
	xmm3 -= xmm0;			/* A8 = A8 - I8 */ \
...
\
	...
	xmm0 *= xptr(screg+scoff+224);		/* B8 = B8 * sine (new I8) */ \
\
	shuffle_store_with_temp(de3[0], de3[1], xmm6, xmm3, xmm4);	/* Save R7,R8 */ \
	shuffle_store_with_temp(de3[2], de3[3], xmm5, xmm0, xmm4);	/* Save I7,I8 */ \
\
	xmm3 = saved_R1;			/* R1 */ \
	xmm4 = saved_R2;		/* R2 */ \
	xmm3 -= xmm4;			/* R1 = R1 - R2 (new R2) */ \
...
\
	shuffle_store(de0[0], de0[1], xmm2, xmm1);				/* Save R1,R2 */ \
	shuffle_store_with_temp(de0[2], de0[3], xmm0, xmm7, xmm1);	/* Save I1,I2 */ \
\
	xmm1 = xptr(screg+scoff+64+16);	/* cosine/sine */ \
	xmm1 *= xmm5;			/* A3 = R3 * cosine/sine */ \
	xmm1 -= xmm4;			/* A3 = A3 - I3 */ \
...
\
	...
	xmm3 *= xptr(screg+scoff+192);		/* B4 = B4 * sine (final I4) */ \
\
	shuffle_store_with_temp(de1[0], de1[1], xmm1, xmm7, xmm0);		/* Save R3,R4 */ \
	shuffle_store_with_temp(de1[2], de1[3], xmm4, xmm3, xmm0);	/* Save I3,I4 */ \
}
...
\
	...
	xmm8 = sd7[1];	/* I8				; 18	avail 5,13,11,15 */ \
\
...
\
	...
	shuffle_store(de0[0], de0[1], xmm12, xmm3);			/* Save R1,R2 starting at clock 46 */ \
...
\
	shuffle_store_with_temp(de0[2], de0[3], xmm15, xmm11, xmm0);	/* Save I1,I2 starting at clock 50 */ \
\
...
\
	...
	shuffle_store(de1[0], de1[1], xmm9, xmm10);			/* Save R3,R4 starting at clock 58 */ \
...
\
	shuffle_store(de1[2], de1[3], xmm3, xmm6);		/* Save I3,I4 starting at clock 60 */ \
\
...
\
	shuffle_store_with_temp(de2[0], de2[1], xmm1, xmm13, xmm4); /* Save R5,R6 */ \
	shuffle_store_with_temp(de2[2], de2[3], xmm14, xmm11, xmm4); /* Save I5,I6 */ \
	shuffle_store_with_temp(de3[0], de3[1], xmm12, xmm2, xmm4); /* Save R7,R8 */ \
	shuffle_store_with_temp(de3[2], de3[3], xmm3, xmm0, xmm4); /* Save I7,I8 */ \
}
#endif
...
#define r8_sg4cl_eight_complex_unfft8(srcreg,srcinc,d1,d2,dstreg,dstinc,e1,e2,screg) { \
	...
	vec2f64 *de2 = (vec2f64*)(dstreg+e2); \
	vec2f64 *de3 = (vec2f64*)(dstreg+e2+e1); \
	shuffle_load_with_temp(xmm7, xmm3, sd0[0], sd0[1], xmm0); /* R1,R2 */ \
...
\
	shuffle_load(xmm2, xmm4, sd0[2], sd0[3]); /* I1,I2 */ \
	xmm7 += xmm2;			/* A1 = A1 + I1 */ \
	...
	xmm4 -= xmm1;			/* B2 = B2 - R2 */ \
\
	shuffle_load_with_temp(xmm5, xmm6, sd1[0], sd1[1], xmm0); /* R3,R4 */ \
	xmm0 = xptr(screg+64+16);		/* cosine/sine */ \
...
\
	shuffle_load(xmm3, xmm7, sd1[2], sd1[3]);	/* I3,I4 */ \
	xmm0 += xmm3;			/* A3 = A3 + I3 */ \
...
\
	...
	shuffle_load_with_temp(xmm7, xmm3, sd2[0], sd2[1], xmm5); /* R5,R6 */ \
...
\
	...
	shuffle_load(xmm2, xmm4, sd2[2], sd2[3]); /* I5,I6 */ \
	xmm7 += xmm2;			/* A5 = A5 + I5 */ \
	...
	xmm4 -= xmm1;			/* B6 = B6 - R6 */ \
\
	shuffle_load_with_temp(xmm5, xmm6, sd3[0], sd3[1], xmm0); /* R7,R8 */ \
	xmm0 = xptr(screg+96+16);		/* cosine/sine */ \
...
\
	shuffle_load(xmm3, xmm7, sd3[2], sd3[3]); /* I7,I8 */ \
	xmm0 += xmm3;			/* A7 = A7 + I7 */ \
...
#define r8_sg4cl_eight_complex_unfft8(srcreg,srcinc,d1,d2,dstreg,dstinc,e1,e2,screg) { \
	...
	vec2f64 *de3 = (vec2f64*)(dstreg+e2+e1); \
	vec2f64 xmm8,xmm9,xmm10,xmm11,xmm12,xmm13,xmm14,xmm15; \
	shuffle_load_with_temp(xmm1, xmm2, sd0[0], sd0[1], xmm0); /* R1,R2 */ \
\
...
\
	shuffle_load_with_temp(xmm6, xmm7, sd0[2], sd0[3], xmm0); /* I1,I2 */ \
\
	xmm3 *= xmm6;			/* B1 = I1 * cosine/sine	; 3-7 */ \
	xmm4 *= xmm7;			/* B2 = I2 * cosine/sine	; 4-8 */ \
\
	shuffle_load_with_temp(xmm8, xmm9, sd1[0], sd1[1], xmm0); /* R3,R4 */ \
\
...
\
	shuffle_load_with_temp(xmm6, xmm14, sd1[2], sd1[3], xmm0); /* I3,I4 */ \
\
...
\
	shuffle_load_with_temp(xmm15, xmm14, sd2[0], sd2[1], xmm7); /* R5,R6 */ \
\
...
\
	...
	shuffle_load_with_temp(xmm1, xmm2, sd2[2], sd2[3], xmm0);	/* I5,I6 */ \
...
\
	...
	shuffle_load_with_temp(xmm5, xmm3, sd3[0], sd3[1], xmm0); /* R7,R8 */ \
...
\
	...
	shuffle_load_with_temp(xmm9, xmm10, sd3[2], sd3[3], xmm2); /* I7,I8 */ \
...
\
	...
	de2[3] = xmm6;		/* I7				; 55	avail 1,6 storable 5,12,8 */ \
...
\
	...
	de1[1] = xmm13;		/* R6				; 71	avail 12,8,10,9,14,7,1,13 storable 15,4,0 */ \
\
	...
	de1[0] = xmm15;		/* R2				; 72	avail 12,8,10,9,14,7,13,15 storable 4,0,2 */ \
\
	xmm11 += xmm5;			/* R8 = R4 + R8 (final R4)	; 73-75	avail 12,8,10,9,14,7,13,15,5 storable 4,0,2,11 */ \
	de3[2] = xmm4;		/* I4				; 73	avail 12,8,10,9,14,7,13,15,5,4 storable 0,2,11 */ \
\
	xmm6 -= xmm3;			/* I2 = I2 - I6 (final I6)	; 74-76	avail 12,8,10,9,14,7,13,15,5,4 storable 0,2,11,6 */ \
	de3[3] = xmm0;		/* I8				; 74	avail 12,8,10,9,14,7,13,15,5,4,0 storable 2,11,6 */ \
\
...
#define r8_sg8cl_sixteen_reals_eight_complex_fft8(srcreg,srcinc,d1,d2,d4,dstreg,dstinc,e1,e2,e4,screg1,screg2) { \
	...
	vec2f64 *de2 = (vec2f64*)(dstreg+e2); \
	vec2f64 *de3 = (vec2f64*)(dstreg+e2+e1); \
	vec2f64 *de4 = (vec2f64*)(dstreg+e4); \
	vec2f64 *de5 = (vec2f64*)(dstreg+e4+e1); \
	vec2f64 *de6 = (vec2f64*)(dstreg+e4+e2); \
	vec2f64 *de7 = (vec2f64*)(dstreg+e4+e2+e1); \
\
...
\
	...
	xmm2 += sd0[0];		/* new R1 = R1 + R9 */ \
\
	xmm1 = sd4[0];		/* R5 */ \
	xmm3 = sd4[1];		/* R13 */ \
	xmm1 -= xmm3;		/* new I9 = R5 - R13 */ \
	xmm3 += sd4[0];		/* new R5 = R5 + R13 */ \
\
...
\
	...
	xmm6 += sd1[0];		/* new R2 = R2 + R10 */ \
\
	xmm5 = sd5[0];		/* R6 */ \
	xmm7 = sd5[1];		/* R14 */ \
	xmm5 -= xmm7;		/* new I10 = R6 - R14 */ \
	xmm7 += sd5[0];		/* new R6 = R6 + R14 */ \
\
...
\
	...
	xmm2 += sd2[0];		/* new R3 = R3 + R11 */ \
\
	xmm1 = sd6[0];		/* R7 */ \
	xmm3 = sd6[1];		/* R15 */ \
	xmm1 -= xmm3;		/* new I11 = R7 - R15 */ \
	xmm3 += sd6[0];		/* new R7 = R7 + R15 */ \
\
...
\
	...
	xmm6 += sd3[0];		/* new R4 = R4 + R12 */ \
\
	xmm5 = sd7[0];		/* R8 */ \
	xmm7 = sd7[1];		/* R16 */ \
	xmm5 -= xmm7;		/* new I12 = R8 - R16 */ \
	xmm7 += sd7[0];		/* new R8 = R8 + R16 */ \
\
...
\
	...
	r4_x8r_fft_mem(de0[0],de0[1],de0[2],de0[3],de1[0],de1[1],de1[2],de1[3],screg1+32,screg1+64,screg1+160,dstreg+dstinc,e1,de0[0],de0[2]); \
	...
	shuffle_store_with_temp(de1[0], de1[1], xmm4, xmm6, xmm7);		/* Save R3,R4 */ \
	shuffle_store_with_temp(de1[2], de1[3], xmm3, xmm2, xmm7);	/* Save I3,I4 */ \
\
...
\
	...
	r4_x4c_fft_mem(de2[0],de2[1],de2[2],de2[3],de3[0],de3[1],de3[2],de3[3],screg1+64,screg1+128,screg1+192,dstreg+dstinc+e2,e1,de2[0],de2[2]); \
	xprefetch(u8ptr(srcreg+srcinc+d2+d1)); \
	shuffle_store_partial(de2[0], de2[1], xmm2, xmm7);			/* Save R1,R2 */ \
	shuffle_store_partial(de2[2], de2[3], xmm5, xmm6);		/* Save I1,I2 */ \
	shuffle_store_with_temp(de3[0], de3[1], xmm3, xmm0, xmm7);	/* Save R3,R4 */ \
	shuffle_store_with_temp(de3[2], de3[3], xmm1, xmm4, xmm7);	/* Save I3,I4 */ \
\
...
\
	...
	xmm6 += xmm4;			/* I5 = I1 + I5 (new I1) */ \
\
	xmm0 -= sd4[2];			/* R1 = R1 - R5 (new R5) */ \
	xmm1 -= sd6[2];			/* R3 = R3 - R7 (new R7) */ \
\
	xmm5 = xmm3;			/* Copy R3 */ \
	xmm3 += xmm2;			/* R3 = R1 + R3 (final R1) */ \
	xmm2 -= xmm5;			/* R1 = R1 - R3 (final R3) */ \
\
	...
	xmm7 += xmm5;			/* I7 = I3 + I7 (new I3) */ \
\
	xmm4 -= sd4[3];			/* I1 = I1 - I5 (new I5) */ \
	xmm5 -= sd6[3];			/* I3 = I3 - I7 (new I7) */ \
\
	de4[0] = xmm3;			/* Save R1 */ \
\
	xmm3 = xmm7;			/* Copy I3 */ \
...
\
	...
	xmm6 += xmm4;			/* I6 = I2 + I6 (new I2) */ \
\
	xmm0 -= sd5[2];			/* R2 = R2 - R6 (new R6) */ \
	xmm1 -= sd7[2];			/* R4 = R4 - R8 (new R8) */ \
\
	xmm5 = xmm3;			/* Copy R4 */ \
	xmm3 += xmm2;			/* R4 = R2 + R4 (final R2) */ \
	xmm2 -= xmm5;			/* R2 = R2 - R4 (final R4) */ \
\
	...
	xmm7 += xmm5;			/* I8 = I4 + I8 (new I4) */ \
\
	xmm4 -= sd5[3];			/* I2 = I2 - I6 (new I6) */ \
	xmm5 -= sd7[3];			/* I4 = I4 - I8 (new I8) */ \
\
	de4[2] = xmm3;			/* Save R2 */ \
\
	xmm3 = xmm7;			/* Copy I4 */ \
...
\
	xmm2 = de6[0];			/* R5 */ \
	xmm2 -= xmm0;			/* R5 = R5 - R6 (new R6) */ \
	xmm0 += de6[0];			/* R6 = R5 + R6 (new R5) */ \
\
	xmm3 = de6[1];			/* I5 */ \
	xmm3 -= xmm1;			/* I5 = I5 - I6 (new I6) */ \
	xmm1 += de6[1];			/* I6 = I5 + I6 (new I5) */ \
\
...
\
	shuffle_store_with_temp(de6[2], de6[3], xmm1, xmm3, xmm7); /* Save I5,I6 */ \
\
...
\
	shuffle_store_with_temp(de7[0], de7[1], xmm6, xmm3, xmm4); /* Save R7,R8 */ \
	shuffle_store_with_temp(de7[2], de7[3], xmm5, xmm0, xmm4); /* Save I7,I8 */ \
\
	xmm3 = de4[0];			/* R1 */ \
	xmm4 = de4[2];			/* R2 */ \
	xmm3 -= xmm4;			/* R1 = R1 - R2 (new R2) */ \
	xmm4 += de4[0];			/* R2 = R1 + R2 (final R1) */ \
\
	xmm7 = de4[1];			/* I1 */ \
	xmm0 = de4[3];			/* I2 */ \
	xmm7 -= xmm0;			/* I1 = I1 - I2 (new I2) */ \
	xmm0 += de4[1];			/* I2 = I1 + I2 (final I1) */ \
\
...
\
	...
	xmm6 = de5[3];			/* I4 */ \
	xmm5 -= xmm6;			/* R3 = R3 - I4 (new R3) */ \
	xmm6 += de5[0];			/* I4 = R3 + I4 (new R4) */ \
\
	shuffle_store_with_temp(de4[0], de4[1], xmm4, xmm1, xmm3); /* Save R1,R2 */ \
\
	xmm3 = de5[1];			/* I3 */ \
	xmm2 = de5[2];			/* R4 */ \
	xmm3 -= xmm2;			/* I3 = I3 - R4 (final I4) */ \
	xmm2 += de5[1];			/* R4 = I3 + R4 (final I3) */ \
\
	shuffle_store_with_temp(de4[2], de4[3], xmm0, xmm7, xmm1); /* Save I1,I2 */ \
\
...
\
	shuffle_store_with_temp(de5[0], de5[1], xmm1, xmm7, xmm0); /* Save R3,R4 */ \
	shuffle_store_with_temp(de5[2], de5[3], xmm2, xmm3, xmm0); /* Save I3,I4 */ \
	dstreg += dstinc; \
}
...
\
	r4_s8r_unfft4(sd0[0],sd0[2],sd0[1],sd0[3],sd1[0],sd1[2],sd1[1],sd1[3], screg1+32,screg1+64,screg1+160,dstreg+dstinc,e1, de3[0],de3[1]); \
...
\
	shuffle_load_with_temp(xmm6, xmm2, sd2[0], sd2[1], xmm4); /* R1,R2 */ \
	xmm4 = xmm2;					/* Copy R2 */ \
	xmm2 *= xptr(screg1+128+16);	/* A2 = R2 * cosine/sine */ \
	shuffle_load_with_temp(xmm1, xmm3, sd2[2], sd2[3], xmm7); /* I1,I2 */ \
	xmm2 += xmm3;					/* A2 = A2 + I2 */ \
	xmm3 *= xptr(screg1+128+16);	/* B2 = I2 * cosine/sine */ \
	xmm3 -= xmm4;					/* B2 = B2 - R2 */ \
	xmm2 *= xptr(screg1+128);		/* A2 = A2 * sine (new R2) */ \
\
	shuffle_load_with_temp(xmm7, xmm0, sd3[0], sd3[1], xmm4); /* R3,R4 */ \
	xmm4 = xmm7;					/* Copy R3 */ \
...
\
	shuffle_load(xmm6, xmm2, sd3[2], sd3[3]); /* I3,I4 */ \
\
	xmm7 += xmm6;			/* A3 = A3 + I3 */ \
...
\
	...
	xmm6[0] -= s61[0];		/* R7 = R7 - R15 (new R15) */ \
\
	/* Odd level 2 */ \
\
	temp1 = xmm1[0]; \
...
\
	/* Even level 1 */ \
	s00 = xptr(srcreg+d1   ); s01 = xptr(srcreg+d1+16   ); \
	s40 = xptr(srcreg+d1+d4); s41 = xptr(srcreg+d1+d4+16); \
	s20 = xptr(srcreg+d1+d2); s21 = xptr(srcreg+d1+d2+16); \
	s60 = xptr(srcreg+d1+d4+d2); s61 = xptr(srcreg+d1+d4+d2+16); \
\
	xmm0[0] = s00[0];		/* R2 */ \
	xmm1[0] = s01[0];		/* R10 */ \
...
\
	...
	xmm6[0] -= s61[0];	/* R8 = R8 - R16 (new R16) */ \
\
	/* Even level 2 */ \
\
	temp1 = xmm1[0]; \
...
#elif 1  // best for x86_64, with 16 vector registers
#define r8_h16r_simple_fft_part1(srcreg,d1,d2,d4,dst) { \
	/* */ \
	/* Do the 16-reals part */ \
	/* */ \
...
#define r8_h8cl_sixteen_reals_eight_complex_with_mult(srcreg,srcinc,d1,d2,d4) { \
	...
	r8_x8c_simple_fft_with_mult(XMM_COL_MULTS_2,src_rbp+d4,d1,d2); \
	r8_x8c_simple_unfft(XMM_COL_MULTS_2,srcreg+d4,d1,d2); \
	r8_h16r_simple_fft_with_mult(XMM_COL_MULTS_1,src_rbp,d1,d2,srcreg); \
	r8_h16r_simple_unfft(XMM_COL_MULTS_1,srcreg+0,d1,d2); \
	srcreg += srcinc; \
}
#else
...
\
	...
	xmm1 += xmm7;			/* R2R2 = R1R1 + R2R2 (new R1R1) */ \
\
	vec2f64 as0 = xptr(altsrc); \
	vec2f64 as2 = xptr(altsrc+32); \
	xmm1[0] *= as0[0];		/* R1 * R1-from-mem */ \
	xmm0[0] *= as2[0];		/* R2 * R2-from-mem */ \
...
\
	...
	xmm3[1] += xmm7[1];			/* I2 = I1 + I2 (new I1) */ \
\
	xs_complex_mult(xmm1[1], xmm3[1], as0[1], as2[1], xmm6[1], xmm7[1]); /* Mult R1/I1 */ \
\
...
\
	xmm4[0] = xmm1[0]; xmm4[1] = xmm0[1];	/* 4: R6 I4 */ \
	xmm5[0] = xmm3[0]; xmm5[1] = xmm1[1];	/* 5: I6 R2 */\
	xmm3[0] = xmm0[0];						/* 3: R5 I4 */ \
\
...
#define r8_h16r_simple_fft_with_mulf(srcreg,d1,d2,dst) { \
	...
	xmm6 = xptr(src_rbx+16);	/*  ? R2 */ \
	xmm3 = xptr(src_rbx+32);	/* R2 I1 */ \
	xmm7 = xptr(src_rbx+48);	/*  ? I2 */ \
\
	xmm4 = xptr(src_rbp); \
	xmm5 = xptr(src_rbp+32); \
\
	xmm1[0] *= xmm4[0];		/* R1 * R1-from-mem */ \
	xmm3[0] *= xmm5[0];	/* R2 * R2-from-mem */ \
	f64ptr(srcreg-16) = xmm1[0];		/* Save product of sum of FFT values */ \
\
	xmm1[0] -= xmm3[0];			/* R1 = R1 - R2 (final R2) */ \
	xmm1[0] *= 0.5;				/* Mul R2 by HALF */ \
	xmm3[0] += xmm1[0];			/* R2 = R1 + R2 (final R1) */ \
\
	xs_complex_mult(xmm1[1], xmm3[1], xmm4[1], xmm5[1], xmm0[1], xmm2[1]); /* Mult R1/I1 */ \
	xp_complex_mult(xmm6, xmm7, xptr(src_rbp+16), xptr(src_rbp+48), xmm0, xmm2); /* Mult R3/I3 Mult R2/I2 */ \
\
	xmm0[0] = xmm3[0]; \
	xmm2[0] = xmm6[0]; \
	xmm3[0] = xmm7[0]; \
						/* R3/I3 morphs into R3/R4 */ \
\
	xmm0[1] = xmm1[1];			/* Copy R1 */ \
	xmm1[1] -= xmm6[1];			/* R1 = R1 - R2 (new R2) */ \
	xmm0[1] += xmm6[1];			/* R2 = R1 + R2 (new R1) */ \
\
	xmm2[1] = xmm3[1];			/* Copy I1 */ \
	xmm3[1] -= xmm7[1];			/* I1 = I1 - I2 (new I2) */ \
	xmm2[1] += xmm7[1];			/* I2 = I1 + I2 (new I1) */ \
\
	xptr2(dst,0) = xmm0;			/* Save R1 R1 */ \
	xptr2(dst,16) = xmm1;			/* Save R2 R2 */ \
	xptr2(dst,32) = xmm2;			/* Save R3 I1 */ \
	xptr2(dst,48) = xmm3;			/* Save R4 I2 */ \
\
	xmm0 = xptr(src_rbx+d1);	/* R5 R3 */ \
	xmm1 = xptr(src_rbx+d1+16);	/* R6 R4 */ \
	xmm2 = xptr(src_rbx+d1+32);	/* I5 I3 */ \
	xmm3 = xptr(src_rbx+d1+48);	/* I6 I4 */ \
\
...
\
	xmm1 = xptr(src_rbx+d2);	/* R9 R5 */ \
	xmm0 = xptr(src_rbx+d2+16);	/* R10 R6 */ \
	xmm3 = xptr(src_rbx+d2+32);	/* I9 I5 */ \
	xmm2 = xptr(src_rbx+d2+48);	/* I10 I6 */ \
\
	xp_complex_mult(xmm1, xmm3, xptr(src_rbp+d2), xptr(src_rbp+d2+32), xmm6, xmm7); /* Mult R9/I9 Mult R5/I5 */ \
	xp_complex_mult(xmm0, xmm2, xptr(src_rbp+d2+16), xptr(src_rbp+d2+48), xmm6, xmm7); /* Mult R10/I10 Mult R6/I6 */ \
\
	xmm7 = xmm1;			/* Copy R5 */ \
	xmm1 -= xmm0;			/* R10R5 = R9R5 - R10R6 (new R10 R6) */ \
	xmm0 += xmm7;			/* R9R6 = R9R5 + R10R6 (new R9 R5) */ \
...
\
	...
	xptr2(dst,d2+16) = xmm1;		/* Save R10 R6 */ \
	xptr2(dst,d2+32) = xmm2;		/* Save I9 I5 */ \
	xptr2(dst,d2+48) = xmm3;		/* Save I10 I6 */ \
\
	xmm0 = xptr(src_rbx+d2+d1);	/* R11 R7 */ \
	xmm3 = xptr(src_rbx+d2+d1+16); 	/* R12 R8 */ \
	xmm1 = xptr(src_rbx+d2+d1+32);	/* I11 I7 */ \
	xmm2 = xptr(src_rbx+d2+d1+48); 	/* I12 I8 */ \
\
	xp_complex_mult(xmm0, xmm1, xptr(src_rbp+d2+d1), xptr(src_rbp+d2+d1+32), xmm6, xmm7); /* Mult R11/I11 Mult R7/I7 */ \
	xp_complex_mult(xmm3, xmm2, xptr(src_rbp+d2+d1+16), xptr(src_rbp+d2+d1+48), xmm6, xmm7); /* Mult R12/I12 Mult R8/I8 */ \
\
	xmm7 = xmm3;			/* Copy R8 */ \
	xmm3 -= xmm0;			/* R12R8 = R12R8 - R11R7 (new I12 I7) */ \
	xmm0 += xmm7;			/* R11R7 = R12R8 + R11R7 (new R11 R7) */ \
...
\
	xptr2(dst,d2+d1   ) = xmm0;		/* Save R11 R7 */ \
	xptr2(dst,d2+d1+16) = xmm1;		/* Save R12 R8 */ \
	xptr2(dst,d2+d1+32) = xmm2;		/* Save I11 I7 */ \
	xptr2(dst,d2+d1+48) = xmm3;		/* Save I12 I8 */ \
}
