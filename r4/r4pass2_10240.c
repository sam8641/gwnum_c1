...
//void r4_pass2_10240_levels_real(struct gwasm_data *__restrict g)
	...
	if(g->ffttype != 4) { //xpass2_10240_levels_real_4;
		...
		rsi += -10*4*dist128;	/* Next source pointer */
	...
	rsi += -20*2*dist128;	/* Next source pointer */
	...
	rsi += -5*8*dist128;	/* Next source pointer */
...
do{
	...
	if(g->ffttype != 4) { //xpass2_10240_levels_complex_4;
		...
		rsi += -10*4*dist128;	/* Restore source pointer */
		end_timer(6);
	...
	rsi += -20*2*dist128;	/* Restore source pointer */
	end_timer(10);
